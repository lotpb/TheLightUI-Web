/**
 * Shared inline icon. strokeWidth 2 with currentColor, so an icon follows its
 * button's hover state — which emoji fundamentally can't: Apple Color Emoji
 * paints its own colour and ignores `color` outright (see the .icon-star note
 * in index.css). Multi-path support is needed for the tag's punch-hole, the
 * printer's indicator dots and the warning triangle's exclamation.
 *
 * The 1.5-stroke single-path `ico()` helper in config/navigation serves the
 * nav rail; this one matches the denser page-level SVGs. Lives here because
 * /dashboard and the four record-list routes both need the same set.
 */
export function Icon({ d, className = 'w-4 h-4' }: { d: string | readonly string[]; className?: string }) {
  return (
...
export const ICONS = {
  ...
  refresh: 'M16.023 9.348h4.992V4.356m-4.992 4.992-3.181-3.183a8.25 8.25 0 0 0-13.803 3.7M4.031 9.865H.039m3.992 0v4.992m0-4.992 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7',
  ...
  ellipsis: 'M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM18.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z',
  ...
  cog: 'M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.03 7.03 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.02-.397-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z',
  cogInner: 'M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z',
  ...
  chevronDoubleLeft: 'm18.75 19.5-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5',
  ...
  // /calendar event types, so its six emoji (📅 🔨 ✅ 🔔 ☐ ↻) can become
  // currentColor SVGs that match the hue of the chip they sit in.
  ...
  // For /portal/:token's invalid-link state, which used a 🔒 emoji.
  ...
  // Added for the record page's action tiles, which were ten colour emoji
  // (💬 ✉️ 🗺️ 📝 🧾 📋 👤 📅 🔗 🖨️) in a grid whose two SVG tiles already
  // demonstrated the right approach.
  ...
  photo: 'm2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Z',
