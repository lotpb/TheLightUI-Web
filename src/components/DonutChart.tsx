...
const URGENCY_LIGHT: Palette = { slices: ['#f43f5e', '#ffff00', '#0284c7', '#059669'], empty: '#a7f3d0' }

const TYPE_DARK: Palette  = { slices: ['#ffff00', '#c77dff', '#00ff9d', '#ff8a00'], empty: '#1a7f5e' }
const TYPE_LIGHT: Palette = { slices: ['#ffff00', '#8b5cf6', '#059669', '#f43f5e'], empty: '#a7f3d0' }

/** Five named slices plus one for "Other" — see MAX_SLICES in the panel. */
const CATEGORY_DARK: Palette  = { slices: ['#7c5cff', '#00ff9d', '#ffff00', '#ff2d55', '#00e5ff', '#ff8a00'], empty: '#1a7f5e' }
const CATEGORY_LIGHT: Palette = { slices: ['#6366f1', '#059669', '#ffff00', '#f43f5e', '#0284c7', '#ea580c'], empty: '#a7f3d0' }
